...
public class Colecoes {
    ...
    */ 
    ...
    public void metodoClassificacao(){
        ...
        /*Aluno d = new Aluno(); // Criação da instância a partir do construtor sem parâmetros
        list.add(d);*/
        
        System.out.println(list);
        
        Collections.sort(list); //classificacao com base no método compareTo
    ...
    public static void main(String[] args) {
      ...
      //new Colecoes(0); //CRIAÇÃO DE NOVA INSTÂNCIA DA CLASSE COLECOES (CHAMADA DO CONSTRUTOR)
      // NÃO HÁ NECESSIDADE DE CRIAR A VARIÁVEL NESSE CASO, POIS PRETENDE-SE APENAS EXECUTAR
            
      //new Colecoes("");
      
      //new Colecoes().metodoHashmap(); //OU
